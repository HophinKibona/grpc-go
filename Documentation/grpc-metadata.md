...
A metadata can be created using package [metadata](https://godoc.org/google.golang.org/grpcv54/metadata).
...
Header and trailer sent along with a unary call can be retrieved using function [Header](https://godoc.org/google.golang.org/grpcv54#Header) and [Trailer](https://godoc.org/google.golang.org/grpcv54#Trailer) in [CallOption](https://godoc.org/google.golang.org/grpcv54#CallOption):
...
Header and trailer can be retrieved from the returned stream using function `Header` and `Trailer` in interface [ClientStream](https://godoc.org/google.golang.org/grpcv54#ClientStream):
...
To send header and trailer to client in unary call, the server can call [SendHeader](https://godoc.org/google.golang.org/grpcv54#SendHeader) and [SetTrailer](https://godoc.org/google.golang.org/grpcv54#SetTrailer) functions in module [grpc](https://godoc.org/google.golang.org/grpcv54).
...
For streaming calls, header and trailer can be sent using function `SendHeader` and `SetTrailer` in interface [ServerStream](https://godoc.org/google.golang.org/grpcv54#ServerStream):
