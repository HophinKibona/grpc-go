...
A metadata can be created using package [metadata](https://godoc.org/google.golang.org/grpc-forked/metadata).
...
Header and trailer sent along with a unary call can be retrieved using function [Header](https://godoc.org/google.golang.org/grpc-forked#Header) and [Trailer](https://godoc.org/google.golang.org/grpc-forked#Trailer) in [CallOption](https://godoc.org/google.golang.org/grpc-forked#CallOption):
...
Header and trailer can be retrieved from the returned stream using function `Header` and `Trailer` in interface [ClientStream](https://godoc.org/google.golang.org/grpc-forked#ClientStream):
...
To send header and trailer to client in unary call, the server can call [SendHeader](https://godoc.org/google.golang.org/grpc-forked#SendHeader) and [SetTrailer](https://godoc.org/google.golang.org/grpc-forked#SetTrailer) functions in module [grpc](https://godoc.org/google.golang.org/grpc-forked).
...
For streaming calls, header and trailer can be sent using function `SendHeader` and `SetTrailer` in interface [ServerStream](https://godoc.org/google.golang.org/grpc-forked#ServerStream):
