...
[`credentials.PerRPCCredentials`](https://godoc.org/google.golang.org/grpcv54/credentials#PerRPCCredentials).
...
https://godoc.org/google.golang.org/grpcv54/credentials/oauth for details.
...
[`WithPerRPCCredentials`](https://godoc.org/google.golang.org/grpcv54#WithPerRPCCredentials).
Or, if user wants to apply OAuth token per call, then configure the grpc RPC
call with `CallOption`
[`PerRPCCredentials`](https://godoc.org/google.golang.org/grpcv54#PerRPCCredentials).
