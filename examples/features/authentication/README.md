...
[`credentials.PerRPCCredentials`](https://godoc.org/google.golang.org/grpc-forked/credentials#PerRPCCredentials).
...
https://godoc.org/google.golang.org/grpc-forked/credentials/oauth for details.

#### Client

On client side, users should first get a valid oauth token, and then call
[`credentials.NewOauthAccess`](https://godoc.org/google.golang.org/grpc-forked/credentials/oauth#NewOauthAccess)
...
[`WithPerRPCCredentials`](https://godoc.org/google.golang.org/grpc-forked#WithPerRPCCredentials).
Or, if user wants to apply OAuth token per call, then configure the grpc RPC
call with `CallOption`
[`PerRPCCredentials`](https://godoc.org/google.golang.org/grpc-forked#PerRPCCredentials).
