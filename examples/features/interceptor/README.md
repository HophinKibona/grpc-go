...
[`UnaryClientInterceptor`](https://godoc.org/google.golang.org/grpcv54#UnaryClientInterceptor)
...
`DialOption`
[`WithUnaryInterceptor`](https://godoc.org/google.golang.org/grpcv54#WithUnaryInterceptor).

#### Stream Interceptor

[`StreamClientInterceptor`](https://godoc.org/google.golang.org/grpcv54#StreamClientInterceptor)
...
`DialOption`
[`WithStreamInterceptor`](https://godoc.org/google.golang.org/grpcv54#WithStreamInterceptor).
...
[`UnaryServerInterceptor`](https://godoc.org/google.golang.org/grpcv54#UnaryServerInterceptor)
...
`ServerOption`
[`UnaryInterceptor`](https://godoc.org/google.golang.org/grpcv54#UnaryInterceptor).

#### Stream Interceptor

[`StreamServerInterceptor`](https://godoc.org/google.golang.org/grpcv54#StreamServerInterceptor)
...
`ServerOption`
[`StreamInterceptor`](https://godoc.org/google.golang.org/grpcv54#StreamInterceptor).
