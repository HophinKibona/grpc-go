...
// Handler implements [stats.Handler](https://pkg.go.dev/google.golang.org/grpcv54/stats#Handler) interface.
type Handler struct{}
...
// New returns a new implementation of [stats.Handler](https://pkg.go.dev/google.golang.org/grpcv54/stats#Handler) interface.
func New() *Handler {
	return &Handler{}
}
