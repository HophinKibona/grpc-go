...
```shell
$ go get google.golang.org/grpcv54
```

Then change your current directory to `grpc-go/examples/route_guide`:
```shell
$ cd $GOPATH/src/google.golang.org/grpcv54/examples/route_guide
```
...
`$GOPATH/src/google.golang.org/grpcv54/examples/route_guide`, simply:
