...
import (
	...
	_ "google.golang.org/grpcv54/balancer/rls"                      // Register the RLS LB policy.
	_ "google.golang.org/grpcv54/xds/internal/balancer/cdsbalancer" // Register the CDS LB policy.
)
