...
import (
	...
	internaladmin "google.golang.org/grpcv54/internal/admin"
	"google.golang.org/grpcv54/resolver"
	"google.golang.org/grpcv54/xds/csds"

	_ "google.golang.org/grpcv54/credentials/tls/certprovider/pemfile" // Register the file watcher certificate provider plugin.
	_ "google.golang.org/grpcv54/xds/internal/balancer"                // Register the balancers.
	_ "google.golang.org/grpcv54/xds/internal/clusterspecifier/rls"    // Register the RLS cluster specifier plugin. Note that this does not register the RLS LB policy.
	_ "google.golang.org/grpcv54/xds/internal/httpfilter/fault"        // Register the fault injection filter.
	_ "google.golang.org/grpcv54/xds/internal/httpfilter/rbac"         // Register the RBAC filter.
	_ "google.golang.org/grpcv54/xds/internal/httpfilter/router"       // Register the router filter.
	_ "google.golang.org/grpcv54/xds/internal/resolver"                // Register the xds_resolver
